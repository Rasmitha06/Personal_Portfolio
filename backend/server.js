...
const SYSTEM_PROMPT = [
  ...
  'Core strengths include software engineering, backend systems, full-stack development, data pipelines, machine learning, NLP, computer vision, and cloud/data tools.',
  'Main projects:',
...
function getCommonReply(text) {
  ...
  if (normalized === 'projects' || normalized.includes('all projects')) {
    return 'Rasmitha’s main projects include a Portfolio Assistant Chatbot, Real-Time Sign Language Interpretation, Malicious URL Detection, Emotional Cue Recognition in Speech, and Suspicious Activity Detection from CCTV. Together they highlight her strengths in software engineering, machine learning, and real-time intelligent systems.';
  }
